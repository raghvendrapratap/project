                                ...
                                <div class="aa-product-view-slider">
                                    <div id="demo-1" class="simpleLens-gallery-container">
                                        ...
                                        <div class="simpleLens-thumbnails-container">
                                            <a data-big-image="admin/resources/pimages/<?php echo $row['image']; ?>" data-lens-image="admin/resources/pimages/<?php echo $row['image']; ?>" class="simpleLens-thumbnail-wrapper" href="#">
                                                <img src="admin/resources/pimages/<?php echo $row['image']; ?>" width='50' height='70'>
                                            </a>
                                            <a data-big-image="img/view-slider/medium/polo-shirt-3.png" data-lens-image="admin/resources/pimages/<?php echo $row['image']; ?>" class="simpleLens-thumbnail-wrapper" href="#">
                                                <img src="admin/resources/pimages/<?php echo $row['image']; ?>" width='50' height='70'>
                                            </a>
                                            <a data-big-image="admin/resources/pimages/<?php echo $row['image']; ?>" data-lens-image="admin/resources/pimages/<?php echo $row['image']; ?>" class="simpleLens-thumbnail-wrapper" href="#">
                                                <img src="admin/resources/pimages/<?php echo $row['image']; ?>" width='50' height='70'>
                            ...
                            <div class="col-md-7 col-sm-7 col-xs-12">
                                <div class="aa-product-view-content">
                                    ...
                                    <div class="aa-prod-view-bottom">
                                        <a class="aa-add-to-cart-btn" href="product.php?id=<?php echo $row['id']; ?>&action=add">Add To Cart</a>
